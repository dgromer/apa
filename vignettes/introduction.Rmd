...
The `*_apa` functions help you to format test outputs according to APA guidelines. The functions take the return value of a test function as the first argument, e.g. a call to `chisq.test`.
