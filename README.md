...
The idea of such formatters was introduced in the [schoRsch package](https://cran.r-project.org/package=schoRsch/). apa generalizes this idea by providing formatters for different output formats (text, Markdown, Quarto, RMarkdown, HTML, LaTeX, LaTeX inline math, docx and R's plotmath syntax).
...
-   `apa()`: A wrapper around the `*_apa()`-functions for use in inline code in Quarto and RMarkdown documents.
